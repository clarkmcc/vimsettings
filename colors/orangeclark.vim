" Vim color file - orangeclark
" Generated by http://bytefluent.com/vivify 2019-12-01
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Identifier guifg=#ffcc00 guibg=NONE guisp=NONE gui=bold ctermfg=220 ctermbg=NONE cterm=bold
...
hi Function guifg=#ff5f5f guibg=NONE guisp=NONE gui=bold ctermfg=203 ctermbg=NONE cterm=bold
...
hi Keyword guifg=#5fffff guibg=NONE guisp=NONE gui=bold ctermfg=87 ctermbg=NONE cterm=bold
